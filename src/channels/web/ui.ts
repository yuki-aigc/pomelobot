...
<body>
  <div class="shell">
    <aside class="panel sidebar">
      <div class="hero">
        <div class="eyebrow">Pomelobot Web Adapter</div>
  ...
  <script>
    (() => {
      ...
      const storageKeys = {
        userName: 'pomelobot.web.userName',
        userId: 'pomelobot.web.userId',
        conversationId: 'pomelobot.web.conversationId',
        authToken: 'pomelobot.web.authToken'
      };
